...
--
-- Host: localhost
-- Generation Time: Nov 09, 2023 at 02:19 PM
...
--
-- Database: `abnormal_traffic_detection`
--
CREATE DATABASE IF NOT EXISTS `abnormal_traffic_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `abnormal_traffic_detection`;
...
(1, 'Ramakrishnan', 'tmksmanju14@gmail.com', 'Ramakrishnan', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(10, 'SVM', '49.71857410881801'),
(11, 'Naive Bayes', '49.812382739212005'),
(12, 'Random Forest Classifier', '51.31332082551595'),
(13, 'Convolution Neural Network (CNN)', '50.469043151969984'),
(14, 'Gradient Boosting Classifier', '48.31144465290807');
...
(15, 'Abnormal', '33.33333333333333'),
(16, 'Normal', '66.66666666666666');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_abnormal_traffic`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_abnormal_traffic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `traffic_date_time` varchar(300) NOT NULL,
  `junction_no` varchar(300) NOT NULL,
  `vechile_type` varchar(300) NOT NULL,
  `no_of_vehicles` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_predict_abnormal_traffic`
--

INSERT INTO `remote_user_predict_abnormal_traffic` (`id`, `Fid`, `lat`, `lon`, `street`, `region`, `traffic_date_time`, `junction_no`, `vechile_type`, `no_of_vehicles`, `Prediction`) VALUES
(1, '203.205.158.61-10.42.0.151-80-44157-6', '40.87705486', '-73.90021502', 'armand place', 'Bronx', '2022-08-23T02:02:56.400Z', '1', 'Pedal cycle', '6', 'Abnormal'),
(2, '10.42.0.211-123.59.190.251-40798-80-6', '40.87277332', '-73.88863329', 'bedford park boulevard', 'Bronx', '2022-08-23T01:33:16.773Z', '2', 'Goods vehicle ', '8', 'Normal'),
(3, '10.42.0.151-104.193.88.109-48413-80-6', '40.86779527', '-73.88146673', 'botanical square', 'Bronx', '2022-08-23T00:55:53.350Z', '2', 'Car', '15', 'Normal'),
(4, '172.217.9.238-10.42.0.151-443-54881-6', '40.80819949', '-73.85603544', 'banes court', 'Bronx', '2022-08-22T23:50:45.500Z', '2', 'Goods vehicle ', '12', 'Normal'),
(5, '10.42.0.1-10.42.0.42-53-14100-17', '40.81123148', '-73.8504329', 'betts avenue', 'Bronx', '2022-08-22T23:48:26.870Z', '2', 'Car', '12', 'Abnormal'),
(6, '192.229.173.173-10.42.0.211-80-48529-6', '40.86628039', '-73.84225481', 'bantam place', 'Bronx', '2022-08-22T06:33:00.937Z', '2', 'Car', '18', 'Normal');
